...
def get_the_email_of_a_townhal_from_its_webpage(temporaire, hashage, name)                                # Definis / parametre / 
  puts temporaire.xpath("/html/body/div/main/section[2]/div/table/tbody/tr[4]/td[2]").text                # Toujours le meme path index / .text = lisible
...
url = "http://www.annuaire-des-mairies.com/val-d-oise.html"                                               # Affiche l'anuaire
