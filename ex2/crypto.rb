...
tab = [] # creation tableau
	...
	doc.css('a.currency-name-container').each_with_index do | prix, nombre |    # with index qui repond a all et le met dans un hash          
...
sleep (3600 - 1584)                                                             # Tant de minutes dans 1h - les trade 
end  